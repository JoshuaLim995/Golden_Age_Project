...
//    private static final String DELETE_DATA = ROOT_URL + "Delete?Delete=";
    ...
    public static final String READ_ALL = ROOT_URL + "API?apicall=ReadAll";
    public static final String DELETE = ROOT_URL + "API?apicall=Delete";
    public static final String READ_DATA = ROOT_URL + "API?apicall=ReadData";
    public static final String URL_UPLOAD_MEDICAL_RECORD = ROOT_URL + "API?apicall=Create_Medical";
    public static final String UPDATE = ROOT_URL + "API?apicall=Update";
