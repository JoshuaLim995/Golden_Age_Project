package com.joshua_lsj.goldenage.OLDD;
...
public class AddClientActivity extends AppCompatActivity {
    ...
    private void registerClient(){
      ...
      VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, URLs.URL_CLIENT_REGISTER,
